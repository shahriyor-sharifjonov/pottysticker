...
var ButtonSlider = (function () {
  ...
  return (
    ...
    (a.prototype.addGetButton = function () {
      return;
      /*  var a=document.getElementById(this.getButtonListId()),b=document.createElement("a");WidgetDOM.setClass(b,"wh-widget-send-button-get-button"),b.setAttribute("href",this.params.proto+"//getbutton.io/?utm_campaign=multy_widget&utm_medium=widget&utm_source="+this.params.clientHostname),b.setAttribute("target","_blank"),b.innerHTML="Get Button";var c=document.createElement("div");WidgetDOM.setClass(c,"clear"),a.appendChild(b),a.appendChild(c)
       */
    }),
    a
  );
